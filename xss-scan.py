...
class BurpExtender(IBurpExtender, IHttpListener, ITab):
    ...
    def _createTopPanel(self):
        ...
        self._applyButtonStyle(self.toggle_btn)
        ...
        self._applyButtonStyle(clear_btn)
        ...
        self._applyButtonStyle(apply_btn)
        ...
        self._applyButtonStyle(run_btn)
    ...
    def _applyButtonStyle(self, button):
    ...
    def _toggle(self, event):
        ...
        self.toggle_btn.setBackground(self.COLOR_SUCCESS if self._isEnabled else self.COLOR_DANGER)
